    ...
    <AuthenticationCard>
        ...
        <div class="mb-4 text-sm text-gray-600 dark:text-gray-400">
            <template v-if="! recovery">
				Confirme o acesso a sua conta utilizando o código de autenticação do seu aplicativo.
            </template>

            <template v-else>
				Confirme o acesso a sua conta utilizando o código de recuperação da sua conta.
            </template>
        </div>
