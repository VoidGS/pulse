...
<template>
    <ActionSection>
        ...
        <template #description>
			Gerencie e deslogue seus logins em outros navegadores e dispositivos.
        </template>

        <template #content>
            <div class="max-w-xl text-sm text-gray-600 dark:text-gray-400">
				Se necessário você pode sair de todas as outras sessões ativas em outros navegadores ou dispositivos. Algumas sessões recentes estão listadas abaixo, mas a lista pode não estar toda aqui. Se você sente que a segurança da sua conta foi comprometida, mude sua senha.
            </div>
            ...
            <div class="flex items-center mt-5">
                <PrimaryButton @click="confirmLogout">
					Deslogue todas as outras sessões
                </PrimaryButton>
            ...
            <DialogModal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
					Insira sua senha para confirmar que você deseja deslogar todas as outras sessões.
